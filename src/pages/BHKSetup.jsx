          ...
          <>
            ...
            <div className="card mt-4 bg-gray-50 border-gray-200">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-semibold text-sm text-ink mb-1">Document wall condition in the next step</p>
                  <p className="text-xs text-gray-500 leading-relaxed">
                    In the next step, photograph walls in every room and note any existing marks, stains or damage. This is your strongest evidence against unfair painting charges at move-out. Painting costs should be discussed at move-out based on actual condition — not pre-agreed.
                  </p>
                </div>
              </div>
            </div>
...
function AddItemForm({ onAdd, onCancel }) {
  const [item, setItem] = useState({ item_name: '', quantity: 1, category: 'Other', tier: 2 })
  return (
